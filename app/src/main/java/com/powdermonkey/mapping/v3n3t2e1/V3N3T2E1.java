...
public class V3N3T2E1 {
    ...
    public static final String ALPHA_UNIFORM = "u_Alpha";

	public static final String POSITION_ATTRIBUTE = "a_Position";
	public static final String NORMAL_ATTRIBUTE = "a_Normal";
	public static final String TEX_ATTRIBUTE = "a_TexCoordinate";
    public static final String ENUM_ATTRIBUTE = "a_Enum";
    ...
    public static final int ENUM_DATA_SIZE = 1;

	/** How many bytes per float. */
	public static final int BYTES_PER_FLOAT = 4;
	public static final int BYTES_PER_INT = 4;

	public static final int STRIDE = (POSITION_DATA_SIZE + NORMAL_DATA_SIZE + TEXTURE_COORDINATE_DATA_SIZE + ENUM_DATA_SIZE)
			* BYTES_PER_FLOAT;
    ...
    public static final int ENUM_DATA_OFFSET = TEXTURE_COORDINATE_DATA_OFFSET + (TEXTURE_COORDINATE_DATA_SIZE * BYTES_PER_FLOAT);
	...
	public void prepare(int program) {
        ...
        alphaUniform = GLES20.glGetUniformLocation(program, ALPHA_UNIFORM);
        ...
        enumAttribute = GLES20.glGetAttribLocation(program, ENUM_ATTRIBUTE);
